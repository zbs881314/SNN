...
def DoG_filter(path_img, filt, img_size, total_time, num_layers):
    ...
    "' DoG filter implementation based on kheradpisheh, S.R. et al. '"
    ...
    # DOG Normalization
    # i""mg_out = DoG_normalization(img)
...
def DoG(size, s1, s2):
    ...
    "' Generate a filter window of size size x size with std of s1 and s2'"

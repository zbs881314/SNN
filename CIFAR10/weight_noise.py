...
noise1 = np.random.normal(arr_m1, arr_std1, size=(a1[0], a1[1])) / 2
noise2 = np.random.normal(arr_m2, arr_std2, size=(a2[0], a2[1])) / 2
noise3 = np.random.normal(arr_m3, arr_std3, size=(a3[0], a3[1])) / 2
noise4 = np.random.normal(arr_m4, arr_std4, size=(a4[0], a4[1])) / 2
noise5 = np.random.normal(arr_m5, arr_std5, size=(a5[0], a5[1])) / 2

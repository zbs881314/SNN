...
try:
    ...
    layer5 = SCNN.SNNLayer(in_size=12544, out_size=1024, n_layer=5, w=w5)
    ...
    layer5 = SCNN.SNNLayer(in_size=12544, out_size=1024, n_layer=5)
...
layerout5 = layer5.forward(tf.reshape(layerout4,[TRAINING_BATCH,12544]))
